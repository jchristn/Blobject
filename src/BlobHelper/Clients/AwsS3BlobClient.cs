...
namespace BlobHelper
{
    ...
    public class AwsS3BlobClient : IBlobClient
    {
        ...
        /// <summary>
        /// Initializes a new instance of the <see cref="AwsS3BlobClient"/> class.
        /// </summary>
        /// <param name="awsSettings">Settings for <see cref="AwsS3BlobClient"/>.</param>
        public AwsS3BlobClient(AwsSettings awsSettings)
        {
            AmazonS3Config s3Config;
            _AwsSettings = awsSettings;
            var s3Credentials = new Amazon.Runtime.BasicAWSCredentials(_AwsSettings.AccessKey, _AwsSettings.SecretKey);

            if (String.IsNullOrEmpty(_AwsSettings.Endpoint))
            {
                var s3Region = _AwsSettings.GetAwsRegionEndpoint();
