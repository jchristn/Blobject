...
#pragma warning disable CS1998 // Async method lacks 'await' operators and will run synchronously
        ...
        /// <summary>
        /// Initializes a new instance of the <see cref="AzureBlobClient"/> class using pre-configured clients.
        /// Use this constructor when you need to authenticate using methods other than connection strings,
        /// such as managed identity, shared access signatures, or Azure AD credentials.
        /// </summary>
        /// <param name="serviceClient">A pre-configured <see cref="BlobServiceClient"/>.</param>
        /// <param name="containerClient">A pre-configured <see cref="BlobContainerClient"/>.</param>
        /// <example>
        /// <code>
        ...
        /// var client = new AzureBlobClient(serviceClient, containerClient);
        /// </code>
        /// </example>
        public AzureBlobClient(BlobServiceClient serviceClient, BlobContainerClient containerClient)
        {
            if (serviceClient == null) throw new ArgumentNullException(nameof(serviceClient));
            if (containerClient == null) throw new ArgumentNullException(nameof(containerClient));
